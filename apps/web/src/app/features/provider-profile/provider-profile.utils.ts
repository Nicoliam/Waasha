/**
 * Slice 10 — Provider profile presentation helpers (web).
 *
 * Framework-free pure functions so form validation, payload building, and
 * state messaging are unit testable without Angular TestBed. No business
 * rules live here: length/type limits mirror the backend profile service,
 * which remains authoritative. All data comes from the real backend API.
 */
