...
@Component({
  selector: 'waasha-mobile-provider-service-editor',
  standalone: true,
      ...
      <form *ngIf="!loading && !loadError" (ngSubmit)="save()" #f="ngForm" class="wa-card wa-form" novalidate>
        ...
        <fieldset class="wa-field">
          ...
          <div class="wa-upload" aria-label="Service image upload">
            <label class="wa-label" for="mServiceImageFile">Upload an image</label>
            <input
              id="mServiceImageFile"
              type="file"
              class="wa-input"
...
export class ProviderServiceEditorPage implements OnInit {
